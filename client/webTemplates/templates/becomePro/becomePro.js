if (Meteor.isClient) {
    Template.becomePro.rendered = function () {
      $('html').css('height','100%');
      $('body').css('height','100%');
...
// transport
    ...
    Template.becomePro.events({
        'click .fs-submit': function (e,t) {
            ...
            var businessName =  $('#q2').val();
            var phoneNum = $('#q3').val();
            var address = $('#q4').val();
            var walkRadius = $('#q5').val();
            var about = $('#q6').val();

           Meteor.apply('AddProProfile',[id, firstName, lastName, businessName, phoneNum, address, walkRadius, about]);
