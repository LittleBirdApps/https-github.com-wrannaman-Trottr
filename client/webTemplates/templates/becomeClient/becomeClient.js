if (Meteor.isClient) {
    Template.becomeClient.rendered = function () {
      $('html').css('height','100%');
      $('body').css('height','100%');
...
// transport
    ...
    Template.becomeClient.events({
        'click .fs-submit': function (e,t) {
            ...
            var address = $('#q3').val();
            var dog1 = $('#q4').val();
            var dog1Info = $('#q4Info').val();


            Meteor.call('AddClientProfile', firstName, lastName, phoneNum, address, dog1, dog1Info, function (err, succ) {
                if (error) {
                    return sweetAlert({
                        title: "Uh Oh!",
                        type: "error",
            ...
            console.log(bothNames, phoneNum, address, dog1, dog1Info);
        }
    });
}
