...
Template.walkerCalendar.rendered = function () {
...
// a WeekView mixin for calculating dates and titles
    ...
    //        var events= [];
    //        walkerAvailabilityEvents = walkerAvailabilityEvents.find();
    //        walkerAvailabilityEvents.forEach(function (evt) {
    //            events.push({
    //                id:evt._id,
    //                title:evt.title,
    //                start:evt.start,
    ...
    //        });
    //        callback(events);
    //        console.log("walker avail " + events);
    //    }
    //});
...
//                var splitDate = thedate.toString().split(" ");
//                var day = splitDate[0] + ",";
//                var month = splitDate[1] + ",";
//                var dayNum = splitDate[2] + ",";
//                var year = splitDate[3].charAt(2) + splitDate[3].charAt(3);
...
//                return allTogetherNow;
        ...
        events: function (start, end, timezone, callback) {
         var events = [];
            ...
            Meteor.call("MyWalkersAvailability", myId, function (error, results) {
                if (error) {
                    return sweetAlert({
                        title: "Uh Oh!",
                        type: "error",
            ...
            Meteor.call("CalEventsAsWalker", Meteor.userId(), function (error,results) {
                if (error) {
                    return sweetAlert({
                        title: "Uh Oh!",
                        type: "error",
                    ...
                    Session.set("CalEventsAsWalker", results);
                     return
                 }
            });
            ...
            var calEvents = Session.get("CalEventsAsWalker");
...
Template.walkerCalendar.events({
...
Template.walkerCalendar.helpers({
    lastMod: function(){
